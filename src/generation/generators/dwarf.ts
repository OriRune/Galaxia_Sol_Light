...
export function generateDwarf(
  generation: Readonly<GalaxyGenerationConfig>,
  diagnostics?: GenerationDiagnostics,
): GeneratedGalaxy {
  if (generation.type !== "dwarf") throw new Error("Dwarf configuration required.");
  ...
  const axisRatio = 0.82 + 0.13 * streams.variation.nextFloat();
